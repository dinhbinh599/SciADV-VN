...
namespace AdvWeb_VN.Data.Migrations
{
    ...
    [Migration("20210827041642_add_like_dislike_comment")]
    partial class add_like_dislike_comment
    {
            ...
            modelBuilder.Entity("AdvWeb_VN.Data.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryID = 1,
                            CategoryName = "News",
                            CreateDate = new DateTime(2021, 8, 27, 11, 16, 40, 521, DateTimeKind.Local).AddTicks(32)
                        },
                        new
                        {
                            CategoryID = 2,
                            CategoryName = "Review",
                            CreateDate = new DateTime(2021, 8, 27, 11, 16, 40, 522, DateTimeKind.Local).AddTicks(1116)
                        },
                        new
                        {
                            CategoryID = 3,
                            CategoryName = "Project",
                            CreateDate = new DateTime(2021, 8, 27, 11, 16, 40, 522, DateTimeKind.Local).AddTicks(1147)
                        },
                        new
                        {
                            CategoryID = 4,
                            CategoryName = "Donate",
                            CreateDate = new DateTime(2021, 8, 27, 11, 16, 40, 522, DateTimeKind.Local).AddTicks(1150)
                        });
                });
            ...
            modelBuilder.Entity("AdvWeb_VN.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "e931c703-080b-451a-bb6d-c321ea204b8f",
                            Name = "admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "dea46147-36d5-4357-9e48-ea2e834ed0d9",
                            Name = "Writer",
            ...
            modelBuilder.Entity("AdvWeb_VN.Data.Entities.SubCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2021, 8, 27, 11, 16, 40, 523, DateTimeKind.Local).AddTicks(9234)
                        },
                        new
                        {
                            SubCategoryID = 2,
                            ...
                            CreateDate = new DateTime(2021, 8, 27, 11, 16, 40, 524, DateTimeKind.Local).AddTicks(1402)
                        },
                        new
                        {
                            SubCategoryID = 3,
                            ...
                            CreateDate = new DateTime(2021, 8, 27, 11, 16, 40, 524, DateTimeKind.Local).AddTicks(1466)
                        },
                        new
                        {
                            SubCategoryID = 4,
                            CategoryID = 2,
                            CategoryName = "Chaos;Child",
                            CreateDate = new DateTime(2021, 8, 27, 11, 16, 40, 524, DateTimeKind.Local).AddTicks(1469)
                        },
                        new
                        {
                            SubCategoryID = 5,
                            CategoryID = 3,
                            CategoryName = "Chaos;Head",
                            CreateDate = new DateTime(2021, 8, 27, 11, 16, 40, 524, DateTimeKind.Local).AddTicks(1471)
                        });
                });
            ...
            modelBuilder.Entity("AdvWeb_VN.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0abe10fd-b626-41aa-a84c-6a066a10c99b",
                            Email = "hoangthuan2092003@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "hoangthuan2092003@gmail.com",
                            NormalizedUserName = "admin",
                            PasswordHash = "AQAAAAEAACcQAAAAEP3fyYivxWHxMMMCCDELJxjEFpdqMNEVcCNx75NOqajBdhJKUTLb4M3cXK+oFX+6xw==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "81f40433-1fce-4c2b-8190-09c18c6627e3",
                            Email = "hoangthuan2092003@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "hoangthuan2092003@gmail.com",
                            NormalizedUserName = "hoho303",
                            PasswordHash = "AQAAAAEAACcQAAAAEMuyErCfrCnV6ecEgsnB4quJ20hAIi8ReUokmpRFVUpynKU/beB2YyuDuQRvBRR/rg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
                            UserName = "hoho303"
